  ...
  return (
    <>
      <Head>
        ...
        />
        <meta property="og:title" content="Shipping Policy" key="title" />
      </Head>
      <FullPageContainer>
        <ShipPolicyPageWrapper>
          <HeaderText>Shipping Policy</HeaderText>
          <p>
            This website is for demonstration purposes and does not involve
            actual sales or shipping of products.
          </p>
          ...
          <p>
            ...
            estimated shipping dates, and other relevant information. Please
            note that no actual products will be shipped.
          </p>
          ...
          <ListWrapper>
            <li>
              ...
              ship the next business day. Delivery times depend on the
              destination and the selected shipping method.
            </li>
            <li>
            ...
            <li>
              <b>Partial Shipments:</b> If you request to ship available items
              in advance of backordered items, additional shipping fees may
              apply. Contact customer support at help@jwtechnexus.com to arrange
              partial shipments.
            </li>
          </ListWrapper>
          <p>
          ...
          <p>
            Free shipping offers on cart values above a certain threshold apply
            to orders simulated as fulfilled and shipped by TechNexus. Free
            shipping covers standard shipping fees and does not include handling
            or tax charges where applicable. These offers are for demonstration
            and are subject to change without notice.
          </p>
          <SubheaderText>Undelivered Packages</SubheaderText>
          <p>
            If a carrier returns an undelivered package to us, we will contact
            you to resolve any issues and confirm a new shipment. If this
            occurs, a simulated full refund, including shipping charges, will be
            issued. For undelivered packages due to the receiver's fault or a
            second return, a refund excluding shipping charges will be issued.
          </p>
          <p>
          ...
          <p>
            ...
            package on the carrier's website.
          </p>
          <SubheaderText>
          ...
          <p>
            ...
            support at help@jwtechnexus.com as soon as possible. Changes can
            only be made before the order has shipped.
          </p>
          <SubheaderText>What shipping methods are available?</SubheaderText>
          <p>
            We offer various shipping methods, including standard, expedited,
            and overnight shipping. The availability of these options depends on
            your location and the items in your order.
          </p>
