...
const Checkout = ({ context }) => {
  ...
  const [input, setInput] = useState({
    ...
    street: "123 Main St", // Placeholder street address
    city: "Anytown", // Placeholder city
    postal_code: "12345", // Placeholder postal code
    state: "CA", // Placeholder state
  })
  ...
  return (
    <div className="flex flex-col items-center pb-10">
      <Head>
        <title>TechNexus - Checkout</title>
        <meta name="description" content={`Check out`} />
        <meta property="og:title" content="TechNexus - Checkout" key="title" />
      </Head>
      <div
        className="
